...
| `microsoft-ad-recovery.txt` | Microsoft Learn, “Active Directory forest recovery guide,” updated 11 July 2025 — https://learn.microsoft.com/en-us/windows-server/identity/ad-ds/manage/forest-recovery-guide/ad-forest-recovery-guide | **Vendor recovery documentation** | Introduction and linked recovery sequence: a forest-wide failure and restoration of at least one DC per domain from backup. **Full** top-level page fetched; linked procedure pages not fetched | A, C |
