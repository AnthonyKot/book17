...
|---|---|---|---|---|---|
| `progress-kb-advisory-2023-05-31-cve-2023-34362.txt` | Progress, "MOVEit Transfer Critical Vulnerability (May 2023) (CVE-2023-34362)", Knowledge Base article, 2023-05-31, updated through June 2023 | **Vendor advisory** — the anchor document cited by the CVE, KEV and analyst posts; includes the 31 May state and revision history | https://community.progress.com/s/article/MOVEit-Transfer-Critical-Vulnerability-31May2023 | **Yes.** The public page is a JavaScript shell. The text was recovered from Wayback captures of Progress's Salesforce Aura API responses; provenance and capture times are recorded in the excerpt. | A, D |
| `progress-kb-advisory-2023-06-09-cve-2023-35036.txt` | Progress, "MOVEit Transfer Critical Vulnerability (CVE-2023-35036) June 9, 2023" | Vendor advisory, second SQLi disclosure | https://community.progress.com/s/article/MOVEit-Transfer-Critical-Vulnerability-CVE-2023-35036-June-9-2023 | **Yes.** Recovered from a Wayback capture of Progress's Salesforce Aura API response; provenance is recorded in the excerpt. | A, D |
| `progress-kb-advisory-2023-06-15-cve-2023-35708.txt` | Progress, "MOVEit Transfer Critical Vulnerability (June 15, 2023)" (CVE-2023-35708) | Vendor advisory, third SQLi disclosure | https://community.progress.com/s/article/MOVEit-Transfer-Critical-Vulnerability-15June2023 | **Yes.** Recovered from a Wayback capture of Progress's Salesforce Aura API response; provenance is recorded in the excerpt. | A, D |
| `progress-kb-service-pack-2023-07-06-three-cves.txt` | Progress, "MOVEit Transfer Service Pack (July 2023)" (CVE-2023-36934, -36932, -36933) | Vendor service-pack advisory; two further SQL-injection CVEs and one exception-handling CVE | Linked from the Progress security page update of 5 July 2023 | **Yes.** Recovered from a Wayback capture of Progress's Salesforce Aura API response; provenance is recorded in the excerpt. | A, D |
...
| File | Document | What it is | URL | Fetched? | Pitch |
|---|---|---|---|---|---|
| `cisa-fbi-aa23-158a.txt` | CISA/FBI joint CSA AA23-158A, "#StopRansomware: CL0P Ransomware Gang Exploits CVE-2023-34362 MOVEit Vulnerability", 2023-06-07, updated 2023-06-16 | **Regulator advisory** — the open-source-qualified 27 May date; LEMURLOOT / human2.aspx; names only CVE-2023-34362; no MOVEit victim count | https://www.cisa.gov/news-events/cybersecurity-advisories/aa23-158a | **Quoted passages only.** cisa.gov returned 403 to curl; two WebFetch passes confirmed the passages used, including the attribution clause omitted by the first search snippet. The limitation is recorded in the excerpt. | A, D |
...
- **AA23-158A raw page** — 403 to curl; only twice-confirmed WebFetch passages are on disk.
